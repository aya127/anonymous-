...
public class Table {
	...
	public Table(String strTableName, String strClusteringKeyColumn,  Hashtable<String,String> htblColNameType )throws DBAppException{
		...
		for (String key : keys){
			...
			case "java.lang.Integer": table.add(new ArrayList<Integer>());		
			break;
			case "java.lang.String": table.add(new ArrayList<String>());
			break;
			
			case "java.lang.double": table.add(new ArrayList<Double>());
				break;
				
			case "java.lang.boolean": table.add(new ArrayList<Boolean>());
				break;
			case "java.lang.Character": table.add(new ArrayList<Character>());
			break;
			case "java.lang.Date": table.add(new ArrayList<Date>());
			break;
				default:
			}
